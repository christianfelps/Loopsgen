...
for (let indice = 0; indice < matriz.length; indice++){
  ...
  console.log(`a soma dos elementos da diagonal principal e: ${somaDiagonalPrincipal}`)
  console.log(`elementos da diagonal secundaria: ${diagonalSecundaria}`)
console.log(`a soma dos elementos da diagonal secundaria e: ${somaDiagonalSecundaria}`)